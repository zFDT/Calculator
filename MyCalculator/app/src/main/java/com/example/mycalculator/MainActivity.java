...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        if (orientation == ORIENTATION_LANDSCAPE){
            Log.i(TAG, "-------------横屏-------------");
            _drg.setVisibility(View.VISIBLE);
            drg.setVisibility(View.VISIBLE);
            sin.setVisibility(View.VISIBLE);
            cos.setVisibility(View.VISIBLE);
            tan.setVisibility(View.VISIBLE);
            bksp.setVisibility(View.VISIBLE);
            ...
            Log.i(TAG, "-------------竖屏-------------");
            _drg.setVisibility(View.GONE);
            drg.setVisibility(View.GONE);
            sin.setVisibility(View.GONE);
            cos.setVisibility(View.GONE);
            tan.setVisibility(View.GONE);
            bksp.setVisibility(View.GONE);
